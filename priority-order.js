/* Preserve original indices: existing mastery records must never move. */
(()=>{
 ...
 ['greenwashing','漂绿；虚假环保宣传','corporate greenwashing','企业漂绿'],
 ['misinformation','错误信息（不必然有意传播）','spread misinformation','传播错误信息'],
 ['disinformation','蓄意传播的虚假信息','a disinformation campaign','虚假信息宣传活动'],
 ['upskilling','技能提升','employee upskilling','员工技能提升'],
 ['reskilling','重新学习岗位技能','workforce reskilling','劳动者技能再培训'],
 ['telemedicine','远程医疗','access to telemedicine','获得远程医疗服务'],
